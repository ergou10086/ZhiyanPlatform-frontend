...
<p>欢迎使用智研平台！本指南将帮助您快速了解和使用平台的核心功能</p>
<h2 id="平台简介" tabindex="-1"><a class="header-anchor" href="#平台简介"><span>平台简介</span></a></h2>
<p>智研平台是一个专为高校科研团队设计的协作与成果管理平台，旨在通过技术手段提升科研创新效率，让知识的生产、沉淀与传承更加高效、有序。</p>
<h2 id="开始使用平台" tabindex="-1"><a class="header-anchor" href="#开始使用平台"><span>开始使用平台</span></a></h2>
<h3 id="注册" tabindex="-1"><a class="header-anchor" href="#注册"><span>注册</span></a></h3>
<p>Zhiyan项目平台的注册需要使用你的邮箱来进行注册</p>
<p><img src="@source/get-started/image-20251209100343146.png" alt="image-20251209100343146"></p>
<p>请注意，密码强度的设置，平台的密码最少需要七位，而且携带至少两种字符</p>
<p>其中所属机构与学校字段建议填写真实信息，方便日后统一组织和管理</p>
<h3 id="登录" tabindex="-1"><a class="header-anchor" href="#登录"><span>登录</span></a></h3>
<h4 id="第三方登录" tabindex="-1"><a class="header-anchor" href="#第三方登录"><span>第三方登录</span></a></h4>
...
<p><img src="@source/get-started/image-20251209100457273.png" alt="image-20251209100457273"></p>
